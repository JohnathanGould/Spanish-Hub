...
export const MASTER = [
  ...
  { es: 'comer', en: 'to eat', type: 'verb', group: 'Core', sentence: { es: 'Quiero comer pan.', en: 'I want to eat bread.' } },
  ...
  { es: 'queso', en: 'cheese', type: 'noun', group: 'Food & Drink', gender: 'm', sentence: { es: 'El queso español es muy bueno.', en: 'Spanish cheese is very good.' } },
  ...
  { es: 'hermano', en: 'brother', type: 'noun', group: 'Family', gender: 'm', sentence: { es: 'Mi hermano vive en Madrid.', en: 'My brother lives in Madrid.' } },
  ...
  { es: 'ciudad', en: 'city', type: 'noun', group: 'Places', gender: 'f', sentence: { es: 'Madrid es una ciudad grande.', en: 'Madrid is a big city.' } },
  { es: 'calle', en: 'street', type: 'noun', group: 'Places', gender: 'f', sentence: { es: 'La calle está muy ocupada.', en: 'The street is very busy.' } },
  { es: 'país', en: 'country', type: 'noun', group: 'Places', gender: 'm', sentence: { es: 'España es un país hermoso.', en: 'Spain is a beautiful country.' } },
  { es: 'playa', en: 'beach', type: 'noun', group: 'Places', gender: 'f', sentence: { es: 'La playa de Barcelona es famosa.', en: 'The beach of Barcelona is famous.' } },
  ...
  { es: 'diez', en: 'ten', type: 'other', group: 'Numbers', sentence: { es: 'Tengo diez euros.', en: 'I have ten euros.' } },
  { es: 'veinte', en: 'twenty', type: 'other', group: 'Numbers', sentence: { es: 'Necesito veinte minutos.', en: 'I need twenty minutes.' } },
  { es: 'cien', en: 'one hundred', type: 'other', group: 'Numbers', sentence: { es: 'Cuesta cien euros.', en: 'It costs one hundred euros.' } },
  ...
  { es: 'agosto', en: 'august', type: 'noun', group: 'Months', gender: 'm', sentence: { es: 'En agosto voy a España.', en: 'In August I go to Spain.' } },
  ...
  // === ADJECTIVES ===
  { es: 'grande', en: 'big / large', type: 'adj', group: 'Adjectives', sentence: { es: 'Madrid es una ciudad muy grande.', en: 'Madrid is a very big city.' } },
  ...
  { es: 'nuevo', en: 'new', type: 'adj', group: 'Adjectives', sentence: { es: 'Tengo un teléfono nuevo.', en: 'I have a new telephone.' } },
  { es: 'viejo', en: 'old', type: 'adj', group: 'Adjectives', sentence: { es: 'Este es un edificio muy viejo.', en: 'This is a very old building.' } },
  { es: 'bonito', en: 'pretty / nice', type: 'adj', group: 'Adjectives', sentence: { es: 'España es un país muy bonito.', en: 'Spain is a very nice country.' } },
  ...
  { es: 'lento', en: 'slow', type: 'adj', group: 'Adjectives', sentence: { es: 'El autobús es muy lento.', en: 'The bus is very slow.' } },
...
export const VERB_TABLE = [
  { inf: 'hablar', en: 'to speak', conj: [{ subj: 'Yo', es: 'hablo', en: 'I speak' }, { subj: 'Tú', es: 'hablas', en: 'You speak' }, { subj: 'Él/Ella', es: 'habla', en: 'He/She speaks' }] },
  { inf: 'beber', en: 'to drink', conj: [{ subj: 'Yo', es: 'bebo', en: 'I drink' }, { subj: 'Tú', es: 'bebes', en: 'You drink' }, { subj: 'Él/Ella', es: 'bebe', en: 'He/She drinks' }] },
  { inf: 'comer', en: 'to eat', conj: [{ subj: 'Yo', es: 'como', en: 'I eat' }, { subj: 'Tú', es: 'comes', en: 'You eat' }, { subj: 'Él/Ella', es: 'come', en: 'He/She eats' }] },
  { inf: 'ser', en: 'to be (permanent)', conj: [{ subj: 'Yo', es: 'soy', en: 'I am' }, { subj: 'Tú', es: 'eres', en: 'You are' }, { subj: 'Él/Ella', es: 'es', en: 'He/She/It is' }] },
  { inf: 'estar', en: 'to be (location)', conj: [{ subj: 'Yo', es: 'estoy', en: 'I am' }, { subj: 'Tú', es: 'estás', en: 'You are' }, { subj: 'Él/Ella', es: 'está', en: 'He/She/It is' }] },
  { inf: 'necesitar', en: 'to need', conj: [{ subj: 'Yo', es: 'necesito', en: 'I need' }, { subj: 'Tú', es: 'necesitas', en: 'You need' }, { subj: 'Él/Ella', es: 'necesita', en: 'He/She needs' }] },
  { inf: 'tener', en: 'to have', conj: [{ subj: 'Yo', es: 'tengo', en: 'I have' }, { subj: 'Tú', es: 'tienes', en: 'You have' }, { subj: 'Él/Ella', es: 'tiene', en: 'He/She has' }] },
  { inf: 'ir', en: 'to go', conj: [{ subj: 'Yo', es: 'voy', en: 'I go' }, { subj: 'Tú', es: 'vas', en: 'You go' }, { subj: 'Él/Ella', es: 'va', en: 'He/She goes' }] },
  { inf: 'querer', en: 'to want', conj: [{ subj: 'Yo', es: 'quiero', en: 'I want' }, { subj: 'Tú', es: 'quieres', en: 'You want' }, { subj: 'Él/Ella', es: 'quiere', en: 'He/She wants' }] },
  { inf: 'poder', en: 'can / to be able', conj: [{ subj: 'Yo', es: 'puedo', en: 'I can' }, { subj: 'Tú', es: 'puedes', en: 'You can' }, { subj: 'Él/Ella', es: 'puede', en: 'He/She can' }] },
  { inf: 'hacer', en: 'to do / make', conj: [{ subj: 'Yo', es: 'hago', en: 'I do/make' }, { subj: 'Tú', es: 'haces', en: 'You do/make' }, { subj: 'Él/Ella', es: 'hace', en: 'He/She does/makes' }] },
];
